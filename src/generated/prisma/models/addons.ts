...
export type AddonsAvgAggregateOutputType = {
  ...
  addon_price: runtime.Decimal | null
}
...
export type AddonsMinAggregateOutputType = {
  ...
  addon_desc: string | null
  addon_price: runtime.Decimal | null
  addon_avail: boolean | null
}
...
export type addonsWhereInput = {
  ...
  addon_id?: Prisma.IntFilter<"addons"> | number
  addon_name?: Prisma.StringFilter<"addons"> | string
...
export type addonsScalarWhereWithAggregatesInput = {
  ...
  addon_id?: Prisma.IntWithAggregatesFilter<"addons"> | number
  addon_name?: Prisma.StringWithAggregatesFilter<"addons"> | string
  addon_desc?: Prisma.StringWithAggregatesFilter<"addons"> | string
  addon_price?: Prisma.DecimalWithAggregatesFilter<"addons"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  addon_avail?: Prisma.BoolWithAggregatesFilter<"addons"> | boolean
}
...
export interface addonsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `addon_id`
   * const addonsWithAddon_idOnly = await prisma.addons.findMany({ select: { addon_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Addons and only return the `addon_id`
   * const addonsWithAddon_idOnly = await prisma.addons.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Addons and only return the `addon_id`
   * const addonsWithAddon_idOnly = await prisma.addons.updateManyAndReturn({
   *   select: { addon_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface addonsFieldRefs {
  readonly addon_id: Prisma.FieldRef<"addons", 'Int'>
  readonly addon_name: Prisma.FieldRef<"addons", 'String'>
  readonly addon_desc: Prisma.FieldRef<"addons", 'String'>
  readonly addon_price: Prisma.FieldRef<"addons", 'Decimal'>
  readonly addon_avail: Prisma.FieldRef<"addons", 'Boolean'>
}
